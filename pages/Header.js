    ...
    <div>
      <StyledHeader>
        ...
        <div className="logo-sub animated-intestation" id="intestationDiv">
          ...
          <div className="subtitle-div">Join the Reality.</div>
          <Image
            width={100}
            height={100}
            src={appIcon}
          ...
          <div className="download-buttons">
            ...
            <button
              onClick={() =>
                window.open(
                  "https://apps.apple.com/it/app/coffy/id6449869930",
                  "_blank",
                  "noopener,noreferrer"
                )
              }
              disabled={false}
            >
              <Image width={100} height={100} src={appleLogo} alt=""></Image>
            </button>
            <button
              onClick={() =>
                window.open(
                  "https://play.google.com/store/apps/details?id=com.coffyhouse.coffy",
                  "_blank",
                  "noopener,noreferrer"
                )
              }
              disabled={false}
            >
              <Image width={100} height={100} src={playLogo} alt=""></Image>
            </button>
          </div>
...
const StyledHeader = styled.header`
  ...
  background: linear-gradient(360deg, #000000 0%, rgba(0, 0, 0, 0) 107.69%),
    linear-gradient(249.8deg, #2b8c35 0%, rgba(0, 0, 0, 0) 84.53%), #000000;
  padding-bottom: 80px;
  width: 100vw;
  display: flex;
  ...
  @media (max-width: 768px) {
    background: linear-gradient(360deg, #000000 0%, rgba(0, 0, 0, 0) 107.69%),
      linear-gradient(249.8deg, #2b8c35 0%, rgba(0, 0, 0, 0) 54.53%), #000000;
    min-height: 100vh;
  }

  .vector {
    margin-top: 50px;
    filter: invert(53%) sepia(90%) saturate(354%) hue-rotate(50deg)
  ...
  .first-block {
    ...
    min-width: 100vw;
    z-index: 10;
    background: radial-gradient(circle 600px at -25% 50%, #46b4bb, transparent),
      radial-gradient(circle 600px at 120% -5%, #0a95e2, transparent), #000000;

    @media (max-width: 768px) {
      background: radial-gradient(
          circle 300px at 120% -5%,
          #0a95e2,
          transparent
        ),
        black;
