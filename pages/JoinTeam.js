...
function JoinTeam() {
  ...
  function saveFileOnDrive(e) {
    ...
    reader.onload = function (e) {
      ...
      fetch(
        "https://script.google.com/macros/s/AKfycbxAE1rMKVaqoyn7K50ijVQFYQR2JfxJwdLrQl8JJErqyYqFX-BXpgNvy-MjIupc7dOW/exec", //your AppsScript URL
    ...
    <JoinTeamWrapper>
      ...
      {submitted && (
        <div className="normal-text">
          Grazie per l&apos;interesse! Ti contatteremo il prima possibile.
        </div>
      )}
      {/* else form */}
      {!submitted && (
        <div>
          <div className="normal-text">
            Non c&apos;è niente di meglio di una StartUp tech per accrescere le
            tue abilità.
          </div>
